...
1. [Feel free to start by raising an issue](https://github.com/bbc/digital-paper-edit-api/issues/new?template=feature_request.md) so that others can be aware of areas where there is active development, and if needed we can synchronies the effort.
...
8. If you've changed APIs, consider [updating the documentation](https://github.com/bbc/digital-paper-edit-api#documentation) and QA Testing docs.
...
- [ ] Update documentation and QA docs where appropriate - [see updating the documentation](https://github.com/bbc/digital-paper-edit-api#documentation)
